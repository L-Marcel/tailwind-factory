...
exports.uniteProperties = uniteProperties;
...
function uniteProperties() {
  ...
  if (_typeof(oldObject) !== "object" || _typeof(newObject) !== "object") {
    return newObject;
  }
  var objectScheme = _objectSpread(_objectSpread({}, oldObject), newObject);
  return Object.entries(objectScheme).reduce(function (prev, _ref) {
    ...
    var oldIsObject = _typeof(oldValue) === "object";
    var newIsObject = _typeof(newValue) === "object";
    var newIsUndefined = typeof newValue === "undefined";
